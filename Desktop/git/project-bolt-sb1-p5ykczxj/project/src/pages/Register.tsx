        ...
        <div className="max-w-xl mx-auto">
          <div className="flex items-center justify-center gap-8 mb-12">
            <div className="flex items-center">
              <div className={`w-6 h-6 rounded-full ${currentStep >= 1 ? 'bg-[#3e5eff]' : 'bg-gray-200'} text-white flex items-center justify-center font-bold text-sm`}>1</div>
              <div className="ml-2">
                <div className="font-bold text-sm">약관 동의</div>
                <div className="text-xs text-gray-500">필수 약관 동의</div>
              </div>
            </div>
            <div className={`w-12 h-[2px] ${currentStep >= 2 ? 'bg-[#3e5eff]' : 'bg-gray-200'}`}></div>
            <div className="flex items-center">
              <div className={`w-6 h-6 rounded-full ${currentStep >= 2 ? 'bg-[#3e5eff]' : 'bg-gray-200'} flex items-center justify-center font-bold text-sm ${currentStep >= 2 ? 'text-white' : 'text-gray-400'}`}>2</div>
              <div className="ml-2">
