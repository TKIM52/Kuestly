        ...
        <div className="col-span-8">
          <div className="bg-white rounded-lg p-6 mb-6">
            <div className="flex items-center gap-4 mb-4">
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <div className="bg-gradient-to-r from-[#3e5eff] to-blue-400 text-transparent bg-clip-text">
            ...
            <div className="flex gap-2 mb-4">
              <span className="px-3 py-1 bg-[#EBEFFF] text-[#3e5eff] rounded-full text-sm">#Quest Token</span>
              <span className="px-3 py-1 bg-[#EBEFFF] text-[#3e5eff] rounded-full text-sm">#거래지원 투표</span>
              <span className="px-3 py-1 bg-[#EBEFFF] text-[#3e5eff] rounded-full text-sm">2025.04.07 11:11 ~ 2025.04.13 24:00</span>
            </div>
            ...
            <div className="space-y-3">
              {questSteps.map((step) => (
                <div key={step.id} className="flex items-center gap-3">
                  ...
                  <div className="flex-1 bg-[#EBEFFF] rounded-lg p-3 flex justify-between items-center hover:bg-[#3e5eff] group transition-all duration-300">
                    <div className="flex items-center gap-3">
                      {step.icon}
                      <span className="font-bold text-[#3e5eff] group-hover:text-white">{step.title}</span>
                    </div>
                    <button 
                      ...
                      className={`px-4 py-1.5 rounded-full text-sm transition-colors ${
                        step.completed
                          ...
                          : 'bg-white text-[#3e5eff] group-hover:bg-[#EBEFFF]'
                      } font-bold`}
                    >
            ...
            <div className="mt-8">
              ...
              <div className="space-y-4 text-[13px] text-gray-600">
                ...
                <div className="relative h-40 w-full rounded-xl overflow-hidden my-8">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-r from-[#3e5eff]/50 to-transparent flex items-center px-8">
          ...
          <div className="bg-white rounded-lg p-6 mb-6">
            ...
            <div className="mb-6">
              <div className="relative h-2 bg-gray-200 rounded-full">
                <div className="absolute left-0 top-0 h-full bg-[#3e5eff] rounded-full" style={{ width: '82%' }} />
              </div>
            ...
            <button 
              ...
              className={`w-full mt-6 py-3 rounded-full font-bold transition-all duration-200 ${
                isClaimed 
                  ...
                  : 'bg-[#EBEFFF] text-[#3e5eff] hover:bg-[#3e5eff] hover:text-white transform hover:translate-z-1'
              }`}
            >
          ...
          <div className="bg-white rounded-lg p-6">
            ...
            <div className="space-y-3">
              {otherEvents.map((event) => (
                <div 
                  key={event.id} 
                  className="border rounded-lg p-3 hover:border-[#3e5eff] transition-all transform hover:-translate-y-1 hover:shadow-lg duration-200 cursor-pointer group"
                >
                  <div className="flex items-center gap-3">
                    <img 
                      src={event.image} 
                    ...
                    <div>
                      ...
                      <div className="text-[#3e5eff] font-bold mt-1 text-sm">{event.amount}</div>
                    </div>
                  </div>
                  <div className="mt-2">
                    <div className="flex gap-1.5">
                      {event.tags.map((tag, index) => (
                        <span 
                          key={index} 
                          className="px-2 py-0.5 bg-[#EBEFFF] text-[#3e5eff] rounded-full text-[10px] group-hover:bg-[#3e5eff] group-hover:text-white transition-colors"
                        >
                          {tag}
                        </span>
                      ))}
                  ...
                  <div className="mt-2">
                    <div className="h-1 bg-gray-100 rounded-full">
                      <div 
                        className="h-full bg-[#3e5eff] rounded-full transition-all duration-300 group-hover:bg-opacity-80" 
