      ...
      <div className="grid grid-cols-12 gap-6">
          ...
          <div className="bg-white rounded-lg p-6">
            ...
            <div className="space-y-4 text-sm">
              <div className="flex items-center justify-between">
                ...
                <button className="px-3 py-1 text-sm bg-[#EBEFFF] text-[#3e5eff] rounded-full hover:bg-[#3e5eff] hover:text-white transition-colors">
                  채널구독
                </button>
              </div>
                  ...
                  <div className="h-[160px]">
                    <ResponsiveContainer width="100%" height="100%">
                      <LineChart data={subscriberData}>
                        ...
                        <Tooltip />
                        <Line type="monotone" dataKey="subscribers" stroke="#3e5eff" />
                      </LineChart>
                    </ResponsiveContainer>
                  </div>
                </div>
                  ...
                  <div className="h-[160px]">
                    <ResponsiveContainer width="100%" height="100%">
                      <LineChart data={postData}>
                        ...
                        <YAxis tick={{ fontSize: 10 }} />
                        <Tooltip />
                        <Line type="monotone" dataKey="posts" stroke="#3e5eff" />
                      </LineChart>
                    </ResponsiveContainer>
                  </div>
                </div>
        ...
        <div className="col-span-8">
          <div className="bg-white rounded-lg p-6">
            ...
            <button className="w-full mt-4 py-2 bg-[#EBEFFF] text-[#3e5eff] rounded-lg hover:bg-[#3e5eff] hover:text-white transition-colors text-sm font-medium">
              더보기
            </button>
          </div>
        </div>
