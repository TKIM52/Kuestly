      ...
      <table className="min-w-full border-collapse">
        ...
        <tbody>
          {data.map((crypto, index) => (
            <tr key={crypto.symbol} className="hover:bg-gray-50 text-sm">
              ...
              <td className="table-cell text-right">
                <div className="flex flex-col items-end">
                  <div className="w-36 relative">
                    <div className="h-4 bg-[#00E676] bg-opacity-10 overflow-hidden">
                      <div 
                        className="absolute top-0 right-0 h-full bg-[#00E676]"
                        style={{ width: `${100 - crypto.botOwnership.percentage}%` }}
                      />
                      <div className="absolute top-0 right-0 h-full flex items-center">
                        <span className={`text-xs font-semibold mr-2 whitespace-nowrap ${
                          100 - crypto.botOwnership.percentage >= 20 ? 'text-white' : 'text-[#00E676]'
                        }`}>
              ...
              <td className="table-cell text-center">
                <button className="px-2 py-0.5 text-xs rounded-full bg-[#00E676] text-white hover:bg-opacity-80 transition-colors">
                  투표하기
                </button>
              </td>
            </tr>
