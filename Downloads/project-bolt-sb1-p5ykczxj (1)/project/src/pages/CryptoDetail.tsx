...
const CustomTooltip = ({ active, payload }: any) => {
  if (active && payload && payload.length) {
    ...
    return (
      <div className="bg-[#00E676] bg-opacity-10 p-3 rounded-lg shadow-lg border border-[#00E676] text-xs">
...
const CustomAreaTooltip = ({ active, payload }: any) => {
  if (active && payload && payload.length) {
    return (
      <div className="bg-[#00E676] bg-opacity-10 p-3 rounded-lg shadow-lg border border-[#00E676]">
...
const CryptoDetail: React.FC = () => {
  ...
  const [priceRange] = useState({ min: '₩114,397,588', max: '₩116,863,560' });
          ...
          <div className="space-y-6">
            <div className="space-y-4">
              <div className="space-y-2">
                <h3 className="text-lg font-bold text-[#00E676]">솔라나란?</h3>
              ...
              <div className="space-y-2">
                <h3 className="text-lg font-bold text-[#00E676]">솔라나의 컨센서스는 무엇인가요?</h3>
                <div className="bg-[#00E676] bg-opacity-10 rounded-lg p-4">
              ...
              <div className="space-y-2">
                <h3 className="text-lg font-bold text-[#00E676]">솔라나 토큰은 어떻게 사용되나요?</h3>
                <p className="text-gray-600 text-sm leading-relaxed mb-2">
                  SOL 토큰은 솔라나(Solana) 네트워크의 자체 토큰입니다. 주 활용처는 다음과 같습니다.
                </p>
                <div className="space-y-2">
                  <div className="flex items-start gap-2">
                    <div className="w-6 h-6 rounded-full bg-[#00E676] text-white flex items-center justify-center flex-shrink-0 mt-0.5">1</div>
                    <p className="text-gray-600 text-sm leading-relaxed">
                      <span className="font-bold">스테이킹:</span> 검증자 노드가 되기 위해서는 SOL 토큰을 네트워크에 스테이킹해야 합니다.
                    </p>
                  </div>
                  <div className="flex items-start gap-2">
                    <div className="w-6 h-6 rounded-full bg-[#00E676] text-white flex items-center justify-center flex-shrink-0 mt-0.5">2</div>
                    <p className="text-gray-600 text-sm leading-relaxed">
        ...
        return (
          <div className="grid grid-cols-3 gap-4">
            {eventData.map((event) => (
              <div 
                key={event.id} 
                className="border-2 border-gray-200 rounded-lg p-4 hover:border-[#00E676] transition-all hover:shadow-lg transform hover:-translate-y-1 duration-200 cursor-pointer"
              >
                ...
                <div className="flex items-center gap-1 mb-3 overflow-hidden">
                  {event.tags.map((tag, index) => (
                    <span key={index} className="px-2 py-0.5 bg-[#00E676] text-white rounded-full text-xs whitespace-nowrap">
                      {tag}
                    </span>
                  ))}
                </div>
                <div className="flex items-center justify-between">
                  ...
                  <div>
                    <span className="text-lg font-bold text-[#00E676]">{event.reward.split(' ')[0]}</span>
                    <span className="ml-1 text-sm font-bold text-[#00E676]">BTC</span>
                  </div>
                </div>
              </div>
            ))}
        ...
        <div className="col-span-4">
          <div className="bg-white rounded-lg p-4 mb-4">
            ...
            <div className="bg-gray-50 p-3 rounded-lg mb-4">
              ...
              <div className="h-1.5 bg-gradient-to-r from-yellow-400 via-[#00E676] to-[#00E676] rounded-full" />
            </div>
            ...
            <div className="space-y-2 text-xs">
              <div className="flex justify-between items-center py-1.5 border-b">
                ...
                <div className="bg-[#00E676] text-white px-2 py-0.5 rounded-full font-bold">
                  {crypto.marketCap}
                </div>
              </div>
              ...
              <div className="space-y-3 text-xs">
                <div className="flex items-center justify-between">
                  ...
                  <a href={`https://${crypto.website}`} target="_blank" rel="noopener noreferrer" 
                     className="bg-[#00E676] text-white px-3 py-1 rounded-full hover:bg-opacity-80 transition-colors">
                     {crypto.website}
                  </a>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-gray-600">백서</span>
                  <a href="#" className="bg-[#00E676] text-white px-3 py-1 rounded-full hover:bg-opacity-80 transition-colors">
                    Whitepaper
                  </a>
                </div>
                <div className="flex items-center justify-between">
              ...
              {['소개', '유통현황', '이벤트'].map((tab) => (
                <button
                  ...
                  className={`px-2.5 py-1 rounded-full text-sm border ${
                    activeTab === tab
                      ? 'bg-[#00E676] text-white border-[#00E676]'
